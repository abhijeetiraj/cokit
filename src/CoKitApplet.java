...
/*
 * <applet code=CoKitApplet width=500 height=700> </applet>
 */
...
public class CoKitApplet extends JApplet
{
    public void init()
    {
        getContentPane().setLayout(new BorderLayout());
        getContentPane().add(new CoKit(this), BorderLayout.CENTER);
    }
